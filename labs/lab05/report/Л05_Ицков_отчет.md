...
Введя соответствующ комманду в терминале я открываю Midnight Commander (рис. [-@fig:001]).

![Отркрытие Midnight Commander](image/1.png){#fig:001 width=70%}

Перехожу в созданный каталог в предыдущей лабораторной работе и создаю подкаталог lab05, в котором буду работать (рис. [-@fig:002]).

![Создание рабочего подкаталога](image/2.png){#fig:002 width=70%}

В строке ввода вводжу команду touch и создаю файл (рис. [-@fig:003]).

![Создание файла в Midnight Commander](image/3.png){#fig:003 width=70%}
...
Изменяю программу lab5-1.asm так, чтобы в конце выводилась введеная мною строка с клавиатуры (рис. [-@fig:014]).

![Редактирование программы](image/14.png){#fig:014 width=70%}
...
Транслирую, компоную и запускаю программу (рис. [-@fig:015]).

![Запуск программы](image/15.png){#fig:015 width=70%}

Изменяю программу lab5-2.asm так, чтобы в конце выводилась введеная мною строка с клавиатуры (рис. [-@fig:016]).
...
Транслирую, компоную и запускаю программу (рис. [-@fig:017]).
